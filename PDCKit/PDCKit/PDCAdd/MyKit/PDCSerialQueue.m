...
@property (strong, nonatomic) NSMutableArray<pdc_operationBlock > *blocks;  //任务组
@property (strong, nonatomic) dispatch_semaphore_t semap;
@end

@implementation PDCSerialQueue
-(NSMutableArray<pdc_operationBlock > *)blocks
{
    if (_blocks == nil)
    {
        _blocks = [NSMutableArray<pdc_operationBlock > array];
    }
    return _blocks;
}
...
-(void )addOperationBlock:(pdc_operationBlock )block
{
